// To Compile
// g++ -Wall $([route]/root-config --libs --cflags) -o top_extractor_all_variables_TS top_extractor_all_variables_TS.C
//
// To run to one file
...
void top_extractor_all_variables_TS() {
...
int main(int argc, char** argv)
{
   ...
   // sprintf(destination_path_variables,"%s.var_list",argv[2]);
    ...
    top_extractor_all_variables_TS();
