...
//
// To Compile
// g++ -Wall $([route]/root-config --libs --cflags) -o top_extractor2 top_extractor2.C
//
// To run to one file
...
//	Char_t   MCkey[MCkeylength]; 		t->SetBranchAddress("MCkey[MCkeylength]", &MCkey[MCkeylength]);
	...
	fprintf(dest_file,"%20.10f",Centrality_AllJets);
	fprintf(dest_file,"%20.10f",Cos_Jet1AllJets_AllJets);
	fprintf(dest_file,"%20.10f",Cos_Jet1Lepton_Lab);
	fprintf(dest_file,"%20.10f",Cos_Jet2AllJets_AllJets);
	fprintf(dest_file,"%20.10f",Cos_Jet2Lepton_Lab);
	fprintf(dest_file,"%20.10f",DeltaPhiJet1Jet2);
	fprintf(dest_file,"%20.10f",DeltaPhiJet1MET);
	fprintf(dest_file,"%20.10f",DeltaPhiJet2MET);
	fprintf(dest_file,"%20.10f",DeltaPhiLeptonMET);
	fprintf(dest_file,"%20.10f",DeltaRJet1Jet2);
	fprintf(dest_file,"%20.10f",DeltaRMinLeptonJet);
	fprintf(dest_file,"%20.10f",EventWeight);
	fprintf(dest_file,"%20.10f",H_AllJets);
	fprintf(dest_file,"%20.10f",H_Jet1Jet2);
	fprintf(dest_file,"%20.10f",HT_AllJets);
	fprintf(dest_file,"%20.10f",HT_AllJetsLeptonMET);
	fprintf(dest_file,"%20.10f",HT_Jet1Jet2);
	fprintf(dest_file,"%20.10f",HT_METlep);
	fprintf(dest_file,"%20.10f",InstLumi);
	fprintf(dest_file,"%20.10f",InvariantMass_AllJets);
	fprintf(dest_file,"%20.10f",InvariantMass_Jet1Jet2);
	fprintf(dest_file,"%20.10f",Jet1MuonPtRel);
	fprintf(dest_file,"%20.10f",Jet2MuonPtRel);
	fprintf(dest_file,"%20.10f",Jet3MuonPtRel);
	fprintf(dest_file,"%20.10f",Jet4MuonPtRel);
	fprintf(dest_file,"%20.10f",LeptonDCA);
	fprintf(dest_file,"%20.10f",LeptonDCASig);
	fprintf(dest_file,"%20.10f",LeptonDetEta);
	fprintf(dest_file,"%20.10f",LeptonDetEtaCFT);
	fprintf(dest_file,"%20.10f",LeptonE);
	fprintf(dest_file,"%20.10f",LeptonEta);
	fprintf(dest_file,"%20.10f",LeptonPhi);
	fprintf(dest_file,"%20.10f",LeptonPt);
	fprintf(dest_file,"%20.10f",METPhi);
	fprintf(dest_file,"%20.10f",METPt);
	fprintf(dest_file,"%20.10f",METPx);
	fprintf(dest_file,"%20.10f",METPy);
	fprintf(dest_file,"%20.10f",MetSig);
	fprintf(dest_file,"%20.10f",Pt_Jet1Jet2);
	fprintf(dest_file,"%20.10f",PVz);
	fprintf(dest_file,"%20.10f",QTimesEta);
//	fprintf(dest_file,"%20.10f",weight_btag);
//	fprintf(dest_file,"%20.10f",weight_btagSF);
//	fprintf(dest_file,"%20.10f",weight_btagTaga);
//	fprintf(dest_file,"%20.10f",weight_Lumi);
//	fprintf(dest_file,"%20.10f",weight_Lumi2);
//	fprintf(dest_file,"%20.10f",weight_LeptonDetEta);
//	fprintf(dest_file,"%20.10f",weight_WPt);
//	fprintf(dest_file,"%20.10f",weight_VJets);
//	fprintf(dest_file,"%20.10f",weight_QCDshape);
//	fprintf(dest_file,"%20.10f",scale_HF);
//	fprintf(dest_file,"%20.10f",scale_MC);
//	fprintf(dest_file,"%20.10f",scale_MC2);
//	fprintf(dest_file,"%20.10f",scale_norm);
//	fprintf(dest_file,"%20.10f",weight_EMcorr);
//	fprintf(dest_file,"%20.10f",weight_Muon_ID);
	fprintf(dest_file,"%20.10f",WPt);
	fprintf(dest_file,"%20.10f",WTransverseMass);
	fprintf(dest_file,"%20.10f",KS_LeptonPt);
	fprintf(dest_file,"%20.10f",KS_METPt);
	fprintf(dest_file,"%20.10f",KS_WTransverseMass);
	fprintf(dest_file,"%20.10f",TrackQPt);
	fprintf(dest_file,"%20.10f",TrackCurvSig);
	fprintf(dest_file,"%20.10f",QTimesLeptonEta);
//	fprintf(dest_file,"%20.10f",w_superOR_trig);
//	fprintf(dest_file,"%20.10f",w_singlelep_trig);
//	fprintf(dest_file,"%20.10f",w_ljets_trig);
//	fprintf(dest_file,"%20i",Is_W1c); 		// Int_t
//	fprintf(dest_file,"%20i",Analysis);		// Int_t
//	fprintf(dest_file,"%20i",EventNumber);		// Int_t
//	fprintf(dest_file,"%20i",MCindex);		// Int_t
//	fprintf(dest_file,"%20i",FiredLepJetsTrigger);	// Int_t
//	fprintf(dest_file,"%20i",FiredSingleLepTrigger);// Int_t
//	fprintf(dest_file,"%20i",Jet1MuonTagCharge);	// Int_t
//	fprintf(dest_file,"%20i",Jet1PartonMatch);	// Int_t
//	fprintf(dest_file,"%20i",Jet2MuonTagCharge);	// Int_t
//	fprintf(dest_file,"%20i",Jet2PartonMatch);	// Int_t
//	fprintf(dest_file,"%20i",Jet3MuonTagCharge);	// Int_t
//	fprintf(dest_file,"%20i",Jet3PartonMatch);	// Int_t
//	fprintf(dest_file,"%20i",Jet4MuonTagCharge);	// Int_t
//	fprintf(dest_file,"%20i",Jet4PartonMatch);	// Int_t
//	fprintf(dest_file,"%20i",LeptonCharge);		// Int_t
//	fprintf(dest_file,"%20i",LeptonNCFTHits);	// Int_t
//	fprintf(dest_file,"%20i",LeptonNSMTHits);	// Int_t
//	fprintf(dest_file,"%20i",NGoodJets);		// Int_t
//	fprintf(dest_file,"%20i",NAllPrimaryVertex);	// Int_t
//	fprintf(dest_file,"%20i",NTaggedJets);		// Int_t
//	fprintf(dest_file,"%20i",RunNumber);		// Int_t
	fprintf(dest_file,"%20.10f",Jet1E);
	fprintf(dest_file,"%20.10f",Jet1Pt);
	fprintf(dest_file,"%20.10f",Jet1Phi);
	fprintf(dest_file,"%20.10f",Jet1Eta);
	fprintf(dest_file,"%20.10f",Jet1DetEta);
	fprintf(dest_file,"%20.10f",Jet1Mass);
	fprintf(dest_file,"%20.10f",Jet1BTagNN);
	fprintf(dest_file,"%20.10f",Jet1QTimesEta);
	fprintf(dest_file,"%20.10f",Jet1Taggability);
	fprintf(dest_file,"%20.10f",Jet1Taggability_Error);
//	fprintf(dest_file,"%20i",Jet1HasMU);// Int_t
//	fprintf(dest_file,"%20i",Jet1Flavor);// Int_t
	fprintf(dest_file,"%20.10f",Jet2E);
	fprintf(dest_file,"%20.10f",Jet2Pt);
	fprintf(dest_file,"%20.10f",Jet2Phi);
	fprintf(dest_file,"%20.10f",Jet2Eta);
	fprintf(dest_file,"%20.10f",Jet2DetEta);
	fprintf(dest_file,"%20.10f",Jet2Mass);
	fprintf(dest_file,"%20.10f",Jet2BTagNN);
	fprintf(dest_file,"%20.10f",Jet2QTimesEta);
	fprintf(dest_file,"%20.10f",Jet2Taggability);
	fprintf(dest_file,"%20.10f",Jet2Taggability_Error);
//	fprintf(dest_file,"%20i",Jet2HasMU);// Int_t
//	fprintf(dest_file,"%20i",Jet2Flavor);// Int_t
	fprintf(dest_file,"%20.10f",Jet3E);
	fprintf(dest_file,"%20.10f",Jet3Pt);
	fprintf(dest_file,"%20.10f",Jet3Phi);
	fprintf(dest_file,"%20.10f",Jet3Eta);
	fprintf(dest_file,"%20.10f",Jet3DetEta);
	fprintf(dest_file,"%20.10f",Jet3Mass);
	fprintf(dest_file,"%20.10f",Jet3BTagNN);
	fprintf(dest_file,"%20.10f",Jet3Taggability);
	fprintf(dest_file,"%20.10f",Jet3Taggability_Error);
//	fprintf(dest_file,"%20i",Jet3HasMU);// Int_t
//	fprintf(dest_file,"%20i",Jet3Flavor);// Int_t
	fprintf(dest_file,"%20.10f",Jet4E);
	fprintf(dest_file,"%20.10f",Jet4Pt);
	fprintf(dest_file,"%20.10f",Jet4Phi);
	fprintf(dest_file,"%20.10f",Jet4Eta);
	fprintf(dest_file,"%20.10f",Jet4DetEta);
	fprintf(dest_file,"%20.10f",Jet4Mass);
	fprintf(dest_file,"%20.10f",Jet4BTagNN);
	fprintf(dest_file,"%20.10f",Jet4Taggability);
	fprintf(dest_file,"%20.10f",Jet4Taggability_Error);
//	fprintf(dest_file,"%20i",Jet4HasMU);// Int_t
//	fprintf(dest_file,"%20i",Jet4Flavor);// Int_t
	fprintf(dest_file,"%20.10f",MostBLikeJetE);
	fprintf(dest_file,"%20.10f",MostBLikeJetPt);
	fprintf(dest_file,"%20.10f",MostBLikeJetPhi);
	fprintf(dest_file,"%20.10f",MostBLikeJetEta);
	fprintf(dest_file,"%20.10f",MostBLikeJetDetEta);
	fprintf(dest_file,"%20.10f",MostBLikeJetBTagNN);
	fprintf(dest_file,"%20.10f",MostBLikeJetLeptonDeltaPhi);
	fprintf(dest_file,"%20.10f",MostBLikeJetQTimesEta);
	fprintf(dest_file,"%20.10f",MostBLikeJetTaggability);
	fprintf(dest_file,"%20.10f",MostBLikeJetTaggability_Error);
//	fprintf(dest_file,"%20i",MostBLikeJetHasMU);// Int_t
//	fprintf(dest_file,"%20i",MostBLikeJetFlavor);// Int_t
	fprintf(dest_file,"%20.10f",LeadingBTaggedJetPt);
	fprintf(dest_file,"%20.10f",LeadingBTaggedJetEta);
	fprintf(dest_file,"%20.10f",LeadingBTaggedJetBTagNN);
	fprintf(dest_file,"%20.10f",LeadingBTaggedJetLeptonDeltaPhi);
	fprintf(dest_file,"%20.10f",SecondBTaggedJetPt);
	fprintf(dest_file,"%20.10f",SecondBTaggedJetEta);
	fprintf(dest_file,"%20.10f",SecondBTaggedJetBTagNN);
	fprintf(dest_file,"%20.10f",SecondBTaggedJetLeptonDeltaPhi);
	fprintf(dest_file,"%20.10f",LeadingLightQuarkJetE);
	fprintf(dest_file,"%20.10f",LeadingLightQuarkJetPt);
	fprintf(dest_file,"%20.10f",LeadingLightQuarkJetPhi);
	fprintf(dest_file,"%20.10f",LeadingLightQuarkJetEta);
	fprintf(dest_file,"%20.10f",LeadingLightQuarkJetMass);
	fprintf(dest_file,"%20.10f",LeadingLightQuarkJetBTagNN);
	fprintf(dest_file,"%20.10f",LeadingLightQuarkJetLeptonDeltaPhi);
	fprintf(dest_file,"%20.10f",SecondLightQuarkJetPt);
	fprintf(dest_file,"%20.10f",SecondLightQuarkJetPhi);
	fprintf(dest_file,"%20.10f",SecondLightQuarkJetEta);
	fprintf(dest_file,"%20.10f",SecondLightQuarkJetMass);
	fprintf(dest_file,"%20.10f",SecondLightQuarkJetBTagNN);
	fprintf(dest_file,"%20.10f",SecondLightQuarkJetLeptonDeltaPhi);
//	fprintf(dest_file,"%20i",MCkeylength);// Int_t
//	fprintf(dest_file,"%  ",MCkey[MCkeylength]);
	fprintf(dest_file,"%20.10f",Jet1BTagMVA);
	fprintf(dest_file,"%20.10f",Jet2BTagMVA);
	fprintf(dest_file,"%20.10f",Jet3BTagMVA);
	fprintf(dest_file,"%20.10f",Jet4BTagMVA);
	fprintf(dest_file,"%20.10f",LeadingLightQuarkJetBTagMVA);
	fprintf(dest_file,"%20.10f",SecondLightQuarkJetBTagMVA);
	fprintf(dest_file,"%20.10f",LeadingBTaggedJetBTagMVA);
	fprintf(dest_file,"%20.10f",SecondBTaggedJetBTagMVA);
	fprintf(dest_file,"%20.10f",MostBLikeJetBTagMVA);
    }
