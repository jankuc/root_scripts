...
//
// To Compile
// g++ -Wall $(root-config --libs --cflags) -o top_extractor_select_variables top_extractor_select_variables.C
//
// To run to one file
...
void top_extractor_select_variables(){
...
int main(int argc, char** argv)
{
   ...
   //sprintf(destination_path_variables,"%s.var_list",argv[2]);
    ...
    top_extractor_select_variables();
