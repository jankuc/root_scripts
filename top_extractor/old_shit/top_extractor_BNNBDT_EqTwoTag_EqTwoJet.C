...
//
// To Compile
// g++ -Wall $(root-config --libs --cflags) -o top_extractor_BNNBDT_EqTwoTag_EqTwoJet top_extractor_BNNBDT_EqTwoTag_EqTwoJet.C
//
// To run to one file
...
void top_extractor_BNNBDT_EqTwoTag_EqTwoJet() {
...
//     sprintf(destination_path_variables,"%s.var_list",argv[2]);
    ...
    top_extractor_BNNBDT_EqTwoTag_EqTwoJet();
