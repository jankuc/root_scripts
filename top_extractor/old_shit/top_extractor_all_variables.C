// To Compile
// g++ -Wall $([route]/root-config --libs --cflags) -o top_extractor_all_variables top_extractor_all_variables.C
//
// To run to one file
...
void top_extractor_all_variables() {
