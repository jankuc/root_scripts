...
int main(int argc, char* argv[])
{
  ...
  if (!strcmp(lepType, "ejets")) m_ltf = 1;
  if (!strcmp(lepType, "mujets")) m_ltf = 2;
  ...
  //TString txt_inPATH = Form("/work/budvar-clued0/fjfi-D0/tt_leptonjets/results_hist/%s_%s_%s_%s_%d.txt", treeType.Data(), runPeriod.Data(), sysSet.Data(), lepType.Data(), mass_point);
//  ifstream myfile;
//  myfile.open(txt_inPATH);
//  myfile>>m_wjets_sf_2>>m_wjets_sf_3>>m_wjets_sf_4;
//  myfile.close();
  m_wjets_sf_2 = 1.;
  m_wjets_sf_3 = 1.;
  m_wjets_sf_4 = 1.;
  std::cout<<"Scale factors used here: Wsf_2jb = "<<m_wjets_sf_2<<"    Wsf_3jb = "<<m_wjets_sf_3<<"    Wsf_4jb = "<<m_wjets_sf_4<<std::endl;
  ...
  for(Int_t type_index = 0; type_index < Ntypes; type_index++) {
      ...
      TString inPATH = Form("/work/budvar-clued0/kuceraja/tt_leptonjets/samples/split_trees_3samples_%s_1119_wlp-wbb_mixup/%s_miniTree.root", lepNNTrees.Data(), Type_CP.Data());
      //        if(type_index == 0) {
      //            inPATH = Form("/work/budvar-clued0/kuceraja/tt_leptonjets/samples/split_trees_3samples_%s_1119/%s_miniTree.root", lepNNTrees.Data(), Type_CP.Data());
      //        }
      //        if(type_index == 1) {
      //            inPATH = Form("/work/budvar-clued0/kuceraja/tt_leptonjets/samples/incl_mva_max_next/split_trees_3samples_%s_1119/%s_miniTree.root", lepNNTrees.Data(), Type_CP.Data());
      //        }

      TString outPATH;
      if (flag_0Tag == 0) {
          outPATH = Form("/work/budvar-clued0/kuceraja/tt_leptonjets/samples/allScaled/split_trees_3samples_%s_1119/%s_miniTree_Allscaled.root", lepNNTrees.Data(), Type_HF.Data());
        } else {
          outPATH = Form("/work/budvar-clued0/kuceraja/tt_leptonjets/samples/allScaled/split_trees_3samples_%s_1119/%s_miniTree.root", lepNNTrees.Data(), Type_HF.Data());
        }

      TFile *fadd = new TFile(inPATH.Data(),"READ");

      //std::cout<<"RP:  '"<<runPeriod<<"'   TB:  '"<<tagBin<<"'   Sample:  '"<<Type_CP<<std::endl;

      //    TH1F *addsfhist = (TH1F*) gDirectory->Get(Form("addSF;1"));
      ...
      Float_t _weight_twoJet = 1.0;
      Float_t _weight_threeJet = 1.0;
      Float_t _weight_fourJet = 1.0;
      ...
      TH1F *h_njt= new TH1F("h_njt","njt",10,0.,10.);
      ...
      for(Long64_t nEvt=0; nEvt<nentries; nEvt++){
          ...
          if (flag_0Tag == 1 && _mva_max > 0.15) continue;

          //      if(type_index != 0 && type_index != 1 && pdf_flag !=0 ) {
          // 			_weight_pdf_Shape = 0.0;
          // 		if(pdf_flag == 1) {
      ...
      if (type_index != 0 && type_index != 1 && flag_0Tag == 0) { //jet weights are empty for data and QCD
      ...
      if (type_index == 1) { // QCD
        ...
        } else if (type_index == 2 || type_index == 3 || type_index == 4) {
          h_mva_max_2jb->Scale(m_wjets_sf_2);
          h_mva_max_next_2jb->Scale(m_wjets_sf_2);
          h_mva_2D_2jb->Scale(m_wjets_sf_2);
        } else if (type_index == 16) { // ttAll
          h_mva_max_2jb->Scale(m_ttbar_sf_ll);
          h_mva_max_next_2jb->Scale(m_ttbar_sf_ll);
          h_mva_2D_2jb->Scale(m_ttbar_sf_ll);
        } else if (type_index == 17) { //ttA
      ...
      if (type_index == 1) { //QCD
          ...
          h_mva_max_3jb->Scale(m_wjets_sf_3);
          h_mva_max_next_3jb->Scale(m_wjets_sf_3);
          h_mva_2D_3jb->Scale(m_wjets_sf_3);
        } else if (type_index == 16) { //ttAll
      ...
      if (type_index == 1) { //QCD
          ...
          h_mva_max_4jb->Scale(m_wjets_sf_4);
          h_mva_max_next_4jb->Scale(m_wjets_sf_4);
          h_mva_2D_4jb->Scale(m_wjets_sf_4);
        } else if (type_index == 16) { //ttAll
      ...
      if (flag_0Tag == 0) std::cout<<"RP:  '"<<runPeriod<<"'   TB:  '"<<tagBin<<"'   Sample:  '"<<Type_CP<<"   N_stat = "<<stat_for_wjets_sf_2[type_index]<<"   "<<stat_for_wjets_sf_3[type_index]<<"   "<<stat_for_wjets_sf_4[type_index] <<std::endl;
      else std::cout<<"RP:  '"<<runPeriod<<"'   TB:  '0Tag'   Sample:  '"<<Type_CP<<"   N_stat = "<<stat_for_wjets_sf_2[type_index]<<"   "<<stat_for_wjets_sf_3[type_index]<<"   "<<stat_for_wjets_sf_4[type_index] <<std::endl;
