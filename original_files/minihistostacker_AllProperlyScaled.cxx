...
int main(int argc, char* argv[])
{
  ...
  const Int_t Ntypes = 18;//!all - 18, ttbar - 12, topmass - 20
   ...
   TString txt_inPATH = Form("/prj_root/2671/top_write/savitsky/WScaleFactors/%s_%s_%s_%s_%d.txt", treeType.Data(), runPeriod.Data(), sysSet.Data(), lepType.Data(), mass_point);
   ifstream myfile;
   ...
   if (type_index == 1) looseTight = "loose-tight";
   ...
   TString outPATH;
   if (flag_0Tag == 0) outPATH = Form("/prj_root/2671/top_write/savitsky/%s/controlplots/final/%s/%s/%s/%s/%s/%s/tight/ff_myhist_%s.root", treeType.Data(), runPeriod.Data(), cutSet.Data(), sysSet.Data(), lepType.Data(), tagBin.Data(), WP.Data(), Type_HF.Data());
   else outPATH = Form("/prj_root/2671/top_write/savitsky/%s/controlplots/final/%s/%s/%s/%s/0Tag/%s/tight/ff_myhist_%s.root", treeType.Data(), runPeriod.Data(), cutSet.Data(), sysSet.Data(), lepType.Data(), WP.Data(), Type_HF.Data());
...
//Declaration of leaf types
   ...
   Float_t _weight_twoJet = 0.0;
   Float_t _weight_threeJet = 0.0;
   Float_t _weight_fourJet = 0.0;
