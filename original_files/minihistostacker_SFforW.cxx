...
//Histogram definition
   ...
   for(Long64_t nEvt=0; nEvt<nentries; nEvt++){//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!redo
...
//!Calculating W+jets SFs
   ...
   TString txt_outPATH = Form("/prj_root/2671/top_write/savitsky/WScaleFactors/%s_%s_%s_%s_%d.txt", treeType.Data(), runPeriod.Data(), sysSet.Data(), lepType.Data(), mass_point);
   ofstream myfile;
