...
input_txt_files_path=/work/budvar-clued0/fjfi-D0/tt_leptonjets/samples_txt_to_root
output_root_files_path=/work/budvar-clued0/fjfi-D0/tt_leptonjets/samples_root_tmp
...
for leptons in ele muo; do # muo ele
	...
	for i in ${input_txt_files_path}/split_trees_3samples_${leptons}_1119/*; do
		echo $i
		$script_path \
		${input_txt_files_path}/split_trees_3samples_${leptons}_1119/$(basename ${i}) \
		${output_root_files_path}/split_trees_3samples_${leptons}_1119/$(basename ${i})
	done
done
