...
int restoreNans(const char* in_file_char, const char* muo_ele) {
  ...
  Int_t NJets;  t_in->SetBranchAddress("NJets", &NJets);  t_out->SetBranchAddress("NJets", &NJets);
  Int_t type;   t_in->SetBranchAddress("type", &type);    t_out->SetBranchAddress("type", &type);
  Float_t Weight; t_in->SetBranchAddress("Weight", &Weight); t_out->SetBranchAddress("Weight", &Weight);
  Int_t train;  t_in->SetBranchAddress("train", &train);  t_out->SetBranchAddress("train", &train);
  Int_t val;    t_in->SetBranchAddress("val", &val);      t_out->SetBranchAddress("val", &val);
